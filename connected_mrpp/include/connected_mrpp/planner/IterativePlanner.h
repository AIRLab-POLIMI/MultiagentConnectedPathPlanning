...
#ifndef INCLUDE_CONNECTED_MRPP_PLANNER_ITERATIVEPLANNER_H_
#define INCLUDE_CONNECTED_MRPP_PLANNER_ITERATIVEPLANNER_H_
...
#endif /* INCLUDE_CONNECTED_MRPP_PLANNER_ITERATIVEPLANNER_H_ */
